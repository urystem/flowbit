...
func (p *poolDB) GetHighestPriceByExSym(ctx context.Context, exName, sym string) (*domain.Exchange, error) {
	const query = `
...
func (p *poolDB) GetHighestPriceByExSymInBackup(ctx context.Context, ex, sym string) (*domain.Exchange, error) {
	const query = `
