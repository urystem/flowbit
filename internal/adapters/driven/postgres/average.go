...
func (db *poolDB) SaveWithCopyFrom(ctx context.Context, avgs []domain.ExchangeAggregation, atTime time.Time) error {
...
// func (db *poolDB) SaveWithBatch(ctx context.Context, avg *domain.ExchangeAvg) error {
// 	const sql = `
